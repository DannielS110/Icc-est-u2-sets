...
public class Ejercicios {
 public Ejercicios(){
    ...
    System.out.println(tieneDuplicados(new int[]{1, 2, 3, 4, 5}));
        ...
        System.out.println(contarPalabrasUnicas(textoLargo));       
        System.out.println("El texto tiene " + contarPalabrasUnicas(textoLargo) + " palabras unicas");
    ...
    public static int contarPalabrasUnicas(String texto) {
...
double promedio = (palabras1.size() + palabras2.size()) / 2.0;
double porcentaje = (comunes.size() * 100.0) / promedio;
